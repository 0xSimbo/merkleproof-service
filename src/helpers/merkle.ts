...
export const createTree = ({ hashedLeaves, unhashedLeaves }: { hashedLeaves?: any[]; unhashedLeaves?: any[] }) => {
...
export const createProof = ({ tree, hashedLeaf }: { tree: MerkleTree; hashedLeaf: string }) => {
